...
- Attempt code:
  - `acoustic_ai/layers/layer_b/attempts/murphy__mvp_1__rain_intensity_seed_pool/`
- Candidate checkpoint:
  - `model/candidates/murphy/mvp_1__rain_intensity_seed_pool/`
...
- Add `layer_b` attempt:
  - id: `murphy__mvp_1__rain_intensity_seed_pool`
  - uses_seed: true
