...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "acoustic_ai/layers/layer_b/attempts/murphy__mvp_1__rain_intensity_seed_pool/data/rain_manifest.csv"
        ),
    )
    parser.add_argument(
        "--val-output",
        type=Path,
        default=Path(
            "acoustic_ai/layers/layer_b/attempts/murphy__mvp_1__rain_intensity_seed_pool/data/rain_manifest_val.csv"
        ),
    )
