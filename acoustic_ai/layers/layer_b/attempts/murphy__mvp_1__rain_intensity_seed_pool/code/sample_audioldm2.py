...
DEFAULT_OUTPUT_DIR = DEBUG_ROOT / "layer_b" / "rain_intensity_seed_pool" / "samples"
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to save the generated WAV file. Defaults to debug/layer_b/rain_intensity_seed_pool/samples/...",
    )
    parser.add_argument(
        "--output_dir",
        type=Path,
        ...
        json.dumps(
            {
                ...
                "guidance_scale": args.guidance_scale,
                "seed": args.seed,
                "spectrogram_renderer": "acoustic_ai.layers.layer_b.attempts.murphy__mvp_1__rain_intensity_seed_pool.code.layer_a_visualization",
