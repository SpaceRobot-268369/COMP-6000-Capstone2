...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Optional negative prompt to suppress hiss/static/insects.",
    )
    parser.add_argument(
        ...
        json.dumps(
            {
                ...
                "guidance_scale": args.guidance_scale,
                "seed": args.seed,
                "spectrogram_renderer": "acoustic_ai.layers.layer_b.attempts.murphy__smoke_2__audioldm2_wind.code.layer_a_visualization",
