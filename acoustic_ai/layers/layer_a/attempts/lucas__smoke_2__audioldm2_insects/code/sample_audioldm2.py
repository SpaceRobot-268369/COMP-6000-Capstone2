"""Inference script for AudioLDM2 using the fine-tuned LoRA adapter.

Generates ambient soundscapes given an environmental text prompt,
merging the pre-trained AudioLDM2 pipeline with our ecoacoustic LoRA weights.
"""
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Text prompt describing the environmental soundscape",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to save the generated WAV file. Defaults to debug/layer_a/audioldm2/samples/...",
    )
    parser.add_argument(
        "--output_dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0015,
        help="Final WAV RMS target for quiet environmental beds. Use <=0 to disable.",
    )
    parser.add_argument(
        "--highpass_hz",
        type=float,
