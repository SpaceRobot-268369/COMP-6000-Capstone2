...
Usage (from project root):
  python3 acoustic_ai/precompute/precompute_spectrograms.py
  python3 acoustic_ai/precompute/precompute_spectrograms.py --workers 8
  python3 acoustic_ai/precompute/precompute_spectrograms.py --dry-run
"""
...
# Add acoustic_ai to path so modules.ambient.preprocess can be imported in worker processes
...
def process_clip(wav_path: str, overwrite: bool) -> tuple[bool, str]:
    ...
    try:
        from modules.ambient.preprocess import load_audio, waveform_to_melspec, pad_or_crop, melspec_to_tensor
