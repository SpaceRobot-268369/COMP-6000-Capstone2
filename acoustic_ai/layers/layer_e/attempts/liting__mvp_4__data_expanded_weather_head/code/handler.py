"""Registry handler for Liting's E-B MVP-4 data-expanded weather head."""
...
DEFAULT_CHECKPOINT = PROJECT_ROOT / "model" / "candidates" / "liting" / "mvp_4__data_expanded_weather_head" / "weather_head.pt"
INTENSITY_VALUE = {
    "none": 0.0,
    "light": 0.25,
    "moderate": 0.6,
...
def analyze(state: dict, audio_path: str | Path) -> dict:
    ...
    weather = {
        "component": "E-B",
        "method": "panns_dsp_frozen_features__data_expanded_weather_head",
        "primary_model": "PANNs CNN14 frozen + data-expanded E-B weather head",
        **prediction,
        ...
        "limitations": [
            "MVP-4 trains small heads over frozen PANNs/DSP features using audited labels plus pseudo-labelled Site257 training-only clips.",
