...
Usage (from project root):
  python3 acoustic_ai/train_vocoder.py
  python3 acoustic_ai/train_vocoder.py --epochs 100 --max-clips 500

Output:
  acoustic_ai/vocoder_checkpoints/best.pt   ← used by inference.py
...
VOCODER_CKPT_DIR = Path(__file__).resolve().parent / "vocoder_checkpoints"
