...
def main():
    ...
    p.add_argument("--checkpoint",  type=Path,
                   default=Path(__file__).resolve().parent.parent / "checkpoints" / "ambient" / "best.pt")
    ...
    from modules.ambient.dataset import SoundscapeDataset, N_ENV_FEATURES
    from modules.ambient.preprocess import SPEC_CFG, FRAMES_PER_CLIP
    ...
    from modules.ambient.dataset import NUMERIC_COLS
