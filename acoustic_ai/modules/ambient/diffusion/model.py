"""Conditioning-agnostic 1D denoising network for the VAE latent space.
...
`cond` can be any vector — previously a 12-dim env one-hot, now a 512-dim
CLAP text embedding. The architecture is fully agnostic to the source.
"""
...
class LatentDenoiser(nn.Module):
    ...
    Args:
      ...
      cond_dim:     conditioning dimensionality — 12 for env one-hot,
                    512 for CLAP text embeddings.
